...
: ${AMENT_CURRENT_PREFIX:="/home/user/workspace/udemy_robot/pratice_ws/install/robot_moveit"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_moveit/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_moveit/environment/path.sh"
